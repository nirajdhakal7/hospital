...
@section('content')
	...
	<form class="p-2" method="POST" action="{{ route('about.store') }}" enctype="multipart/form-data">
		<div class="form-row">
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control {{ $errors->first('address')?'is-invalid':'' }}"
				       value="{{ old('address')}}" name="address" id="inputAddress"
				       placeholder="Address">
		...
		<div class="form-row">
			<div class="form-group col-md-6">
				...
				<input type="tel" class="form-control {{ $errors->first('phone_no')?'is-invalid':'' }}"
				       value="{{ old('phone_no')}}" name="phone_no" id="inputPhone"
			...
			<div class="form-group col-md-6">
				...
				<input type="tel" class="form-control {{ $errors->first('slogan')?'is-invalid':'' }}"
				       value="{{ old('slogan')}}" name="slogan" id="inputSlogan"
