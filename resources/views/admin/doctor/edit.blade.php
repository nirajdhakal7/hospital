...
@section('content')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            <div class="btn-group mr-2">
                <a href="{{ route('doctor.index')}}" class="btn btn-sm btn-outline-secondary">Back</a>
    ...
    @endif
    <form action="{{ route('doctor.update',['doctor'=>$doctor->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        {{-- Name--}}
        <div class="form-row">
